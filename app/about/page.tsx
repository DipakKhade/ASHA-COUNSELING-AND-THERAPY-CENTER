...
export const metadata: Metadata = {
  title: "About - Asha Counseling And Therapy Center",
  description:
    "I'm Poonam Gupta, a dedicated Psychologist and Counselor with over 5 years of experience helping individuals improve their mental and emotional well-being.",
};
    ...
    <>
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center bg-primary-light/50 rounded-3xl p-8 sm:p-12">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-dark mb-4">
