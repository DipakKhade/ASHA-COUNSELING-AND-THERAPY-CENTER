    ...
    <section className="py-16 sm:py-20 bg-gradient-to-r from-primary to-primary-dark text-white overflow-hidden">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute -bottom-16 -left-16 w-48 h-48 rounded-full bg-white/5 animate-float" style={{ animationDelay: "1s", animationDuration: "4s" }} />
        </div>
        ...
        <AnimateOnScroll>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-white text-primary-dark px-8 py-4 rounded-full text-lg font-semibold hover:bg-primary-light transition-all shadow-lg hover:shadow-xl active:scale-95"
          >
