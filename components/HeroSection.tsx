  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary-light via-white to-accent-light min-h-[70vh] flex items-center">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <motion.div
          className="absolute -bottom-32 -left-32 w-80 h-80 rounded-full bg-accent/5"
          animate={{ y: [0, 12, 0] }}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 w-full">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <AnimateOnScroll className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 justify-center lg:justify-start">
              <motion.a
                ...
                className="inline-flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-full text-sm sm:text-base font-semibold shadow-lg"
          ...
          <AnimateOnScroll variant="scaleIn" className="hidden lg:flex justify-center">
            <motion.div
